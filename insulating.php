   ...
   $sql = "SELECT * FROM `insulating`";
        ...
        while($value = mysqli_fetch_object($test))
        {
            ...
            <div class="box" data-aos="fade-up" data-aos-delay="200">
              <img src="assets/img/prd/ins'.$imgid.'.jpg" class="img-fluid" alt="">
              <h3 id="prd'.$imgid.'"> '.$value->prdname.'</h3>
              <p>'.$value->prddes.'</p>
              <p hidden id="txt'.$imgid.'">'.$value->prdsizetblname.'</p>
              <p hidden id="qtyval'.$imgid.'">'.$value->qtyval.'</p>
...
<br>
  <div class="form-group">
    <label for="nos">Enter value in<span id="extn"></span></label>
    <input type="number" class="form-control" id="nos" aria-describedby="emailHelp" placeholder="Enter Value">
  </div>
  <br>
